package br.com.ebac.ebac_logs.controller;
    ...
    public String mostraMensagem() {
        ...
        if (urlServico2.length() > 0) {
            final String mensagemDeles = restTemplate
                    .exchange(urlServico2, HttpMethod.GET, null, new ParameterizedTypeReference<String>() {}).getBody();

            return "Eu disse isso aqui: " + mensagem + "e eles disseram isso: (" + mensagemDeles + ")";
        }

        return "E eu deveria parar por arqui.";
    }
}
